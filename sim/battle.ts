	...
	sendUpdates() {
		...
		if (!this.sentEnd && this.ended) {
			const log = {
				...
				p1team: this.sides[0].toPokefindPokemon(),
				p2team: this.sides[1].toPokefindPokemon(),
				p3team: this.sides[2] && this.sides[2].toPokefindPokemon(),
				p4team: this.sides[3] && this.sides[3].toPokefindPokemon(),
