export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	kyotodragonite: {
		...
		abilities: {0: "Reckless", 1: "Volt Absorb", H: "Swift Swim"},
		heightm: 2.2,
		weightkg: 210,
		color: "Unknown",
	...
	kyotosnorlax: {
		...
		abilities: {0: "Poison Touch", 1: "Ripen", H: "Quick Draw"},
		heightm: 2.1,
		weightkg: 460,
		color: "Unknown",
		eggGroups: ["Monster"],
	...
	kyotogengar: {
		...
		abilities: {0: "Magic Guard", 1: "Trace", H: "Prankster"},
		heightm: 1.5,
		weightkg: 40.5,
		color: "Unknown",
		eggGroups: ["Amorphous"],
	...
	kyotoarcanine: {
		...
		abilities: {0: "Intimidate", 1: "Innards Out", H: "Drizzle"},
		heightm: 1.9,
		weightkg: 155,
		color: "Unknown",
		eggGroups: ["Field"],
	...
	kyotoalakazam: {
		...
		abilities: {0: "Infiltrator", 1: "Magic Bounce", H: "Mega Launcher"},
		heightm: 1.5,
		weightkg: 48,
		color: "Unknown",
	...
	kyotorhydon: {
		...
		abilities: {0: "Skill Link", 1: "Static", H: "Analytic"},
		heightm: 1.9,
		weightkg: 120,
		color: "Unknown",
		evos: ["Shiloh Rhyperior"],
	...
	zeinovazoroark: {
		...
		abilities: {0: "Sheer Force", 1:"Dazzling", H:"Misty Surge"},
		heightm: 1.6,
		weightkg: 81.1,
		color: "Unknown",
		eggGroups: [],
	...
	shilohmismagius: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 105, def: 60, spa: 120, spd: 60, spe: 105},
		abilities: {0: "Illusion", 1:"Sand Rush", H:"Technician"},
		heightm: 1.6,
		weightkg: 81.1,
		color: "Unknown",
		eggGroups: [],
	...
	haikousharpedo: {
		...
		abilities: {0: "Toxic Debris", 1:"Corrosion", H:"Sheer Force"},
		heightm: 1.8,
		weightkg: 88.8,
		color: "Blue",
		prevo: "Carvanha",
	...
	shilohyanmega: {
    	...
    	abilities: {0: "Speed Boost", 1:"Merciless", H:"Sheer Force"},
    	heightm: 1.9,
    	weightkg: 51.5,
    	color: "Unknown",
    	eggGroups: ["Bug"],
 	...
 	shilohweavile: {
    	...
    	abilities: {0: "Sand Force", 1:"Merciless", H:"Sap Sipper"},
    	heightm: 1.1,
    	weightkg: 34,
    	color: "Unknown",
    	eggGroups: ["field"],
 	...
 	shilohheatran: {
    	...
    	abilities: {0: "Sand Rush", 1:"Earth Eater", H:"Steam Engine"},
    	heightm: 1.7,
    	weightkg: 430,
    	color: "Unknown",
 	...
 	zeinovaescavalier: {
    	...
    	abilities: {0: "Defiant", 1:"Hustle", H:"Quick Draw"},
    	heightm: 1,
    	weightkg: 33,
    	color: "Unknown",
    	eggGroups: ["Bug"],
 	...
 	zeinovareuniclus: {
    	num: -10172,
    	name: "Zeinova Reuniclus",
    	tags: ["Zeinova"],
    	types: ["Poison", "Fairy"],
    	genderRatio: {M:0.5, F: 0.5},
    	baseStats: {hp:110, atk:65, def:75, spa: 125, spd: 85, spe: 30},
    	abilities: {0: "Toxic Debris", 1:"Prankster", H:"Regenerator"},
    	heightm: 1,
    	weightkg: 20.1,
    	color: "Unknown",
    	eggGroups: ["amorphous"],
 	...
 	zeinovaamoonguss: {
    	...
    	abilities: {0: "Regenerator", 1:"Iron Barbs", H:"Good as Gold"},
    	heightm: 0.6,
    	weightkg: 10.5,
    	color: "Unknown",
    	eggGroups: ["grass"],
 	...
 	shilohpalkia: {
    	...
    	abilities: {0: "Trace", 1:"Marvel Scale", H:"Soul-Heart"},
    	heightm: 4.2,
    	weightkg: 336,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
 	...
 	shilohdialga: {
    	...
    	abilities: {0: "Guts", 1:"Marvel Scale", H:"Scrappy"},
    	heightm: 5.4,
    	weightkg: 683,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
 	...
 	zeinovamienshao: {
    	num: -10176,
    	name: "Zeinova Mienshao",
    	tags: ["Zeinova"],
    	types: ["Grass", "Dark"],
    	genderRatio: {M:0.5, F:0.5 },
    	baseStats: {hp:65, atk:125, def:60, spa: 95, spd: 60, spe: 105},
    	abilities: {0: "Technician", 1:"Adaptability", H:"Sharpness"},
    	heightm: 1.4,
    	weightkg: 35.5,
    	color: "Unknown",
    	eggGroups: ["human-like", "field"],
 	...
 	jataroskarmory: {
    	...
    	abilities: {0: "Stamina", 1:"Simple", H:"Poison Heal"},
    	heightm: 1.7,
    	weightkg: 50.5,
    	color: "Unknown",
    	eggGroups: ["flying"],
	...
	shilohbronzong: {
    	...
    	abilities: {0: "Levitate", 1:"Magnet Pull", H:"Static"},
    	heightm: 1.3,
    	weightkg: 187.0,
    	color: "Unknown",
    	eggGroups: ["mineral"],
 	...
 	jataroraikou: {
    	...
    	abilities: {0: "Intimidate", 1:"Berserk", H:"Dark Aura"},
    	heightm: 1.9,
    	weightkg: 178.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
 	...
 	jatarosuicune: {
    	...
    	abilities: {0: "Intimidate", 1:"Wandering Spirit", H:"Misty Surge"},
    	heightm: 2.0,
    	weightkg: 187.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
 	...
 	jataroentei: {
    	...
    	abilities: {0: "Intimidate", 1:"Shadow Shield", H:"Sheer Force"},
    	heightm: 2.1,
    	weightkg: 198.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	haikouswellow: {
    	...
    	abilities: {0: "Tough Claws", 1:"Liquid Voice", H:"Galvanize"},
    	heightm: 0.7,
    	weightkg: 19.8,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	shilohelectivire: {
    	num: -10183,
    	name: "Shiloh Electivire",
    	tags: ["Shiloh"],
    	types: ["Steel"],
		genderRatio: {M: 0.75, F: 0.25},
    	baseStats: {hp:75, atk:123, def:67, spa: 95, spd: 85, spe: 95},
    	abilities: {0: "Steelworker", 1:"Iron Barbs", H:"Sharpness"},
    	heightm: 1.8,
    	weightkg: 138.6,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	shilohmagmortar: {
    	num: -10184,
    	name: "Shiloh Magmortar",
    	tags: ["Shiloh"],
    	types: ["Psychic", "Fighting"],
		genderRatio: {M: 0.75, F: 0.25},
    	baseStats: {hp:75, atk:95, def:67, spa: 125, spd: 95, spe: 83},
    	abilities: {0: "Psychic Surge", 1:"Quick Feet", H:"Flare Boost"},
    	heightm: 1.6,
    	weightkg: 68.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	haikouhariyama: {
    	num: -10185,
    	name: "Haikou Hariyama",
    	tags: ["Haikou"],
    	types: ["Water", "Dark"],
		genderRatio: {M: 0.75, F: 0.25},
    	baseStats: {hp:144, atk:120, def:60, spa: 40, spd: 60, spe: 50},
    	abilities: {0: "Iron Fist", 1:"Water Veil", H:"Stamina"},
    	heightm: 2.3,
    	weightkg: 253.8,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	shilohmagnezone: {
    	num: -10186,
    	name: "Shiloh Magnezone",
    	tags: ["Shiloh"],
    	types: ["Grass", "Poison"],
		gender: "N",
    	baseStats: {hp:70, atk:70, def:115, spa: 130, spd: 90, spe: 60},
    	abilities: {0: "Thick Fat", 1:"Neutralizing Gas", H:"Chlorophyll"},
    	heightm: 1.2,
    	weightkg: 180.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	zeinovasamurott: {
    	num: -10187,
    	name: "Zeinova Samurott",
    	tags: ["Zeinova"],
    	types: ["Rock", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
    	baseStats: {hp:95, atk:100, def:85, spa: 108, spd: 70, spe: 70},
    	abilities: {0: "Sand Rush", 1:"Rock Head", H:"Magic Guard"},
    	heightm: 1.5,
    	weightkg: 94.6,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	shilohspiritomb: {
    	num: -10188,
    	name: "Shiloh Spiritomb",
    	tags: ["Shiloh"],
    	types: ["Water", "Ground"],
		genderRatio: {M: 0.5, F: 0.5},
    	baseStats: {hp:50, atk:92, def:108, spa: 92, spd: 108, spe:35 },
    	abilities: {0: "Comatose", 1:"Liquid Ooze", H:"Water Absorb"},
    	heightm: 1.0,
    	weightkg: 108.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	shilohambipom: {
    	...
    	abilities: {0: "Slush Rush", 1:"Infiltrator", H:"Gorilla Tactics"},
    	heightm: 1.2,
    	weightkg: 20.3,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	jatarolanturn: {
    	...
    	abilities: {0: "Regenerator", 1:"Huge Power", H:"Filter"},
    	heightm: 1.2,
    	weightkg: 22.5,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	zeinovabisharp: {
    	num: -10191,
    	name: "Zeinova Bisharp",
    	tags: ["Zeinova"],
    	types: ["Poison", "Dragon"],
		genderRatio: {M: 0.5, F: 0.5},
    	baseStats: {hp:65, atk:125, def:100, spa: 60, spd: 70, spe: 70},
    	abilities: {0: "Poison Touch", 1:"Multiscale", H:"Dragon's Maw"},
    	heightm: 1.6,
    	weightkg: 70.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	haikouwailord: {
    	...
    	abilities: {0: "Heavy Metal", 1:"Aerilate", H:"Motor Drive"},
    	heightm: 14.5,
    	weightkg: 398.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	jataromiltank: {
    	...
    	abilities: {0: "Normalize", 1:"Sand Stream", H:"Cheek Pouch"},
    	heightm: 1.2,
    	weightkg: 75.5,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
