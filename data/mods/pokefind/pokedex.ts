export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	...
	shilohyanmega: {
    	...
    	abilities: {0: "Speed Boost", 1:"Mold Breaker", H:"Sheer Force"},
    	heightm: 1.9,
    	weightkg: 51.5,
    	color: "Unknown",
    	eggGroups: ["Bug"],
 	...
 	shilohweavile: {
    	...
    	abilities: {0: "Sandstream", 1:"Magic Guard", H:"Sap Sipper"},
    	heightm: 1.1,
    	weightkg: 34,
    	color: "Unknown",
    	eggGroups: ["field"],
	...
	shilohbronzong: {
 	...
 	jataroentei: {
  	...
  	shilohelectivire: {
    	...
    	abilities: {0: "Steelworker", 1:"Rough Skin", H:"Sharpness"},
    	heightm: 1.8,
    	weightkg: 138.6,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	shilohmagmortar: {
    	...
    	abilities: {0: "Psychic Surge", 1:"Quick Feet", H:"Adaptability"},
    	heightm: 1.6,
    	weightkg: 68.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	zeinovasamurott: {
    	...
    	abilities: {0: "Sandstream", 1:"Rock Head", H:"Magic Guard"},
    	heightm: 1.5,
    	weightkg: 94.6,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	shilohspiritomb: {
   	...
   	shilohambipom: {
    	...
    	abilities: {0: "Refrigerate", 1:"Infiltrator", H:"Gorilla Tactics"},
    	heightm: 1.2,
    	weightkg: 20.3,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
  	...
  	jatarolanturn: {
   	...
   	haikouwailord: {
    	...
    	abilities: {0: "Heavy Metal", 1:"Cloud Nine", H:"Motor Drive"},
    	heightm: 14.5,
    	weightkg: 398.0,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
   	...
   	jataromiltank: {
    	...
    	abilities: {0: "Normalize", 1:"Sand Spit", H:"Cheek Pouch"},
    	heightm: 1.2,
    	weightkg: 75.5,
    	color: "Unknown",
    	eggGroups: ["undiscovered"],
